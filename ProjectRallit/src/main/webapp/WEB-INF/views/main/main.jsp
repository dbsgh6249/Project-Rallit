		...
		<footer class="css-nzv1o8">
			...
			<div class="css-8t0ewa">
				<div class="css-192tn2r">
					<div class="css-120gsus">
						<a aria-label="홈" href="/"><svg viewBox="0 0 82 22" width="82"
				...
				<p class="css-b3uwyt">
					(주)인프랩 | 대표 : 이형주 | 개인정보보호책임자 : 이동욱 | 사업자등록번호 : 499-81-00612 |
					직업정보제공사업 신고번호 : J1516020220003<br>경기도 성남시 분당구 대왕판교로 660 유스페이스
					1A동 405호 <br>©Rallit. All rights reserved.
				</p>
			</div>
		</footer>
