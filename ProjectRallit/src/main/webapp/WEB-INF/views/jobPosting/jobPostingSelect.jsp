...
<head>
    ...
    <meta charset="utf-8">
    <title>채용 공고 - 랠릿</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0, user-scalable=yes">
    <meta name="title" content="채용 공고 - 랠릿">
    <meta name="description" content="나에게 딱 맞는 회사의 채용 채용 공고을 랠릿에서 찾아보세요!">
    ...
    <meta property="og:description" content="나에게 딱 맞는 회사의 채용 채용 공고을 랠릿에서 찾아보세요!">
    ...
    <link rel="icon" href="resources/imgs/favicon.ico" sizes="any">
    <link rel="icon" href="resources/imgs/favicon.svg" type="image/svg+xml">
    <link rel="mask-icon" href="resources/imgs/favicon.svg" color="#000000">
    <link rel="apple-touch-icon" href="resources/imgs/favicon-180x180.png">
            ...
            <nav class="css-o8aacz">
                <div class="left-GNB css-p1vanc">
                    ...
                    <div class="GNB-menu__noti-container css-176b8zp"">
                       <a href="/ex/"><h1 class="css-1ttw3p7"><strong class="visually-hidden">랠릿</strong><svg viewbox="0 0 82 22"
                ...
                <div class="right-GNB css-5by9vu">
                    <div data-error="false" class="css-lqsfrb"><label>
                            <div class=" header__search-wrapper css-1u763tv">
                                <input type="text" placeholder="회사/채용 공고 검색" spellcheck="false" data-testid="input"
                                    value="" class="css-10xzrfw">
                                <button type="button" aria-label="search" class="css-1gerhyj"><svg width="16"
                                        height="16" fill="none" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M14.374 8.75a5.623 5.623 0 0 1-5.625 5.625A5.627 5.627 0 0 1 3.124 8.75a5.625 5.625 0 1 1 11.25 0zm-1.025 5.925a7.5 7.5 0 1 1 1.325-1.325l3.8 3.8a.938.938 0 1 1-1.325 1.325l-3.8-3.8z"
                                            fill="#535961"></path>
                                    </svg></button>
        ...
        <footer class="css-nzv1o8">
            ...
            <div class="css-8t0ewa">
                <div class="css-192tn2r">
                    <div class="css-120gsus"><a aria-label="홈" href="/ex/"><svg viewbox="0 0 82 22" width="82"
                    ...
                    <div class="css-sx764e">
                        <div class="css-p1vanc"><a href="/ex/" target="_blank" rel="noreferrer" class="css-0">기업
                                서비스</a><a href="https://www.inflearn.com" target="_blank" rel="noreferrer"
                                class="css-0">인프런</a></div>
                        <div class="css-szycpx"><a href="terms-of-service.html" target="_blank" rel="noreferrer"
                                class="css-0">이용약관</a><a href="privacy-policy.html" target="_blank" rel="noreferrer"
                                class="css-0">개인정보 처리방침</a><a
                                href="https://inflearn.typeform.com/rallit-cs#rallit_id=&rallit_email=" target="_blank"
                                rel="noreferrer" class="css-0">문의하기</a><a href="propose-feature.html">기능 제안하기</a></div>
                    </div>
                </div>
